 ...
 * @author Neal Tanner
 */
public class EventEditorTableModel extends AbstractTableModel
{
    private String[] columnNames = {"Property Name","Value"};
    private String[] rowNames = {"Event ID",
                                "Fired?",
                                "Enabled?",
                                "Workslate ID"};
    ...
    public EventEditorTableModel()
    {
        setRowNames();
    }//end default constructor

    public EventEditorTableModel(boolean isEditable)
    {
