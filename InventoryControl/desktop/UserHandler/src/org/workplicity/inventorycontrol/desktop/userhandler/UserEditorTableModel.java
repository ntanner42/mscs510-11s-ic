 ...
 * @author Neal Tanner
 */
public class UserEditorTableModel extends AbstractTableModel
{
    private String[] columnNames = {"Property Name","Value"};
    private String[] rowNames = {"Person ID",
                                "First Name (Required)",
                                "Last Name (Required)",
                                "E-mail (Required)",
                                "Phone (Required)",
    ...
    public UserEditorTableModel()
    {
        setRowNames();
    }//end default constructor

    public UserEditorTableModel(boolean isEditable)
    {
